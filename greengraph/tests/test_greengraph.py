...
class TestGreengraph(unittest.TestCase):
    ...
    @mock.patch("geopy.geocoders.GoogleV3", Geocoder)
    ...
    def test_location_sequence(self):
        ...
        # Test with some real location
        ljubljana = Greengraph("Start","End").geolocate("Ljubljana")
        london = Greengraph("Start","End").geolocate("London")
        print(ljubljana)
        print(london)
